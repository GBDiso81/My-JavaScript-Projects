...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/circleblue3.jpg")';
            //Active player may only be 'X' or 'O' so, if not 'X', it must be 'O'.
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = 'url("images/circlered.jpg")';
        }
...
//drawline() function is called to draw a line if a win condition is met.
function checkWinConditions() {
    ...
    //X 6, 4, 2 condition.
    else if(arrayIncludes('6X', '4X', '2X')) {drawWinLine(100, 500, 510, 90) }
    //X 0, 4, 8 condition.
    ...
    //O 6, 4, 2 condition.
    else if(arrayIncludes('6O', '4O', '2O')) {drawWinLine(100, 500, 510, 90) }
    //O 0, 4, 8 condition.
    ...
    // 9 squares are selected, the code executes.
        ...
        audio('./media/audio1.wav');
        //This function sets a .3s timeout before the resetGame() function is called.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all inmcluded in our array then
...
//This function takes a string parameter of the path you set eaarlier for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y = y1;
    //This funnction interacts with the canvas.
    function animateLineDrawing() {
        //This variable creates a loop.
        const animationLoop = requestAnimationFrame(animateLineDrawing);
        //This method cldears content from the last loop iteration.
    ...
    //This function clears our canvas after a win line is drawn.
    function clear() {
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variable accesses the HTML element id.
        let square = document.getElementById(String(i));
        //This removes the background image from the square.
        square.style.backgroundImage = '';
    }
    //This resets the selectedSquares array so it is empty.
    selectedSquares = [];
}
